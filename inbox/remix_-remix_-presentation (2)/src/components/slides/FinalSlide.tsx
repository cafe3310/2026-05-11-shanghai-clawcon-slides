    ...
    <SlideWrapper>
      <div className="w-full h-full flex relative z-0 bg-[#EFECE8] text-[#1D1D1D] overflow-hidden items-center justify-center">
        ...
        <div className="w-full max-w-5xl relative z-10 flex flex-col items-center mt-[-10px]">
          ...
          <p className="text-xl text-[#3A3935] mb-12 text-center max-w-3xl leading-relaxed">
          ...
          <div className="w-full grid grid-cols-2 gap-8 items-stretch h-[260px]">
            ...
            {/* Left: JSON Block */}
            <div className="bg-[#1D1D1D] text-[#EFECE8] rounded-xl p-8 font-mono text-sm leading-relaxed shadow-lg relative overflow-hidden text-left flex flex-col justify-center">
...
<span className="text-[#D3B47D]">{"}"}</span>
            ...
            <div className="bg-white/60 rounded-xl p-8 border border-[#1D1D1D]/10 shadow-sm shadow-[#1D1D1D]/5 flex flex-col justify-center text-left relative">
               ...
               <div className="relative z-10 pl-4">
                 <p className="text-xl text-[#3A3935] leading-relaxed font-display tracking-wide mb-8">
                   <strong className="text-[#1D1D1D] font-medium">宁可左右脑互搏卡死，也绝不给你编瞎话。</strong>
                   <br/><br/>少了点“人味儿”，但天生是个打工圣体。
                 </p>
                 <div className="text-sm font-mono tracking-widest text-[#8A8985] uppercase flex items-center">
          ...
          <div className="w-full mt-10 flex items-center justify-between border-t border-[#1D1D1D]/10 pt-6">
            ...
            <div className="flex items-center space-x-8">
              <div className="flex flex-col">
                 <span className="text-xs text-[#8A8985] font-mono tracking-wider uppercase mb-2">Status</span>
                 <div className="flex items-center text-[#4B6A53] bg-[#4B6A53]/10 px-3 py-1.5 rounded font-medium text-sm border border-[#4B6A53]/20">
              ...
              <div className="flex flex-col">
                 <span className="text-xs text-[#8A8985] font-mono tracking-wider uppercase mb-2">Website</span>
                 <div className="flex items-center text-[#1D1D1D] text-sm">
            ...
            <div className="flex flex-col items-end">
               <span className="text-xs text-[#8A8985] font-mono tracking-wider uppercase mb-2">Contact</span>
               <div className="flex items-center text-[#3A3935] text-sm">
                 ...
                 <span className="text-[#8A8985] text-sm">（全网固定三花猫头像 🐈）</span>
               </div>
            </div>
