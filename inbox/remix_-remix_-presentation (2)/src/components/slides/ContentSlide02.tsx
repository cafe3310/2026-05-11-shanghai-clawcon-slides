    ...
    <SlideWrapper>
      <div className="w-full h-full pt-20 px-16 pb-16 flex flex-col relative z-0">
        ...
        <div className="mb-12 max-w-6xl pl-4">
          <div className="font-mono text-sm tracking-widest text-prussian uppercase mb-4 font-semibold">
            CAPABILITY MATRIX
          </div>
        ...
        <div className="flex-1 relative flex flex-col">
          ...
          {/* Y Axis Label */}
          <div className="absolute -left-12 top-1/2 -translate-y-1/2 -rotate-90 text-sm font-sans tracking-widest text-dark/40 whitespace-nowrap flex items-center gap-4 z-10">
            <span>低</span>
          ...
          <div className="flex-1 grid grid-cols-2 grid-rows-2 border-y border-prussian/20 relative">
            ...
            <div className="border-b border-prussian/20 p-12 lg:p-14 flex flex-col justify-center">
              <div className="font-mono text-lg text-prussian/40 tracking-widest uppercase mb-4 select-none">Q1 / 绝对好球区</div>
              <h3 className="font-display text-4xl text-dark mb-4">编程代码生成、<br/>会议纪要、周报月报、方案初稿</h3>
              <p className="font-sans text-xl font-light text-dark/70 leading-relaxed pr-8">
            ...
            <div className="bg-gray-light/50 border-b border-prussian/20 p-12 lg:p-14 flex flex-col justify-center relative">
              ...
              <div className="font-mono text-lg text-prussian/60 tracking-widest uppercase mb-4 select-none">Q2 / 被低估的潜力区</div>
              <h3 className="font-display text-4xl text-dark mb-4">年终总结、绩效草稿、<br/>招聘辅助、复杂需求分析</h3>
              <p className="font-sans text-xl font-light text-dark/80 leading-relaxed mb-6 pr-8">
              ...
              <div className="bg-white/60 p-4 border border-prussian/10 flex gap-4 mt-auto items-start">
                ...
                <p className="font-sans text-base text-dark/80 pt-1">
            ...
            <div className="p-12 lg:p-14 flex flex-col justify-center">
              <div className="font-mono text-lg text-prussian/40 tracking-widest uppercase mb-4 select-none">Q3 / 高危结构化任务</div>
            ...
            <div className="bg-prussian text-white p-12 lg:p-14 flex flex-col justify-center shadow-[inset_0_20px_40px_rgba(0,0,0,0.2)]">
              <div className="font-mono text-lg text-white/50 tracking-widest uppercase mb-4 select-none">Q4 / 不适合直接交接</div>
              <h3 className="font-display text-4xl text-white mb-4">心理治疗情绪干预、投资<br/>与股市分析、纯主观价值判断</h3>
              <p className="font-sans text-xl font-light text-white/80 leading-relaxed pr-8 mb-6">
          ...
          {/* X Axis Label */}
          <div className="absolute -bottom-8 left-0 right-0 flex items-center justify-center text-sm font-sans tracking-widest text-dark/40 z-10 w-full pl-6 pr-6">
            <span>容易补齐</span>
