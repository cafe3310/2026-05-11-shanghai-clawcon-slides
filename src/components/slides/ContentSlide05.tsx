    ...
    <SlideWrapper>
      <div className="w-full h-full pt-20 px-24 pb-16 flex relative z-0">
        ...
        <div className="w-1/2 h-full flex flex-col justify-center pl-8">
          ...
          <div className="mb-10">
            <div className="font-mono text-[24px] tracking-widest text-[#FF5F56] uppercase mb-4 font-semibold">
              02 / SECURE
            </div>
          ...
          <div className="flex flex-col gap-6">
            <p className="font-sans text-[24px] font-light text-dark/70 leading-relaxed border-l-2 border-[#FF5F56]/30 pl-5">
            ...
            <div className="mt-4 flex flex-col">
              ...
              <div className="bg-dark/5 border border-dark/10 p-4 rounded-xl flex items-center gap-4 relative">
                ...
                <div className="flex gap-2 flex-wrap flex-1">
                  <span className="text-[24px] font-mono bg-white px-2 py-0.5 rounded border border-dark/5 text-dark/60">Chat History</span>
                  <span className="text-[24px] font-mono bg-white px-2 py-0.5 rounded border border-dark/5 text-dark/60">Persona</span>
                  <span className="text-[24px] font-mono bg-white px-2 py-0.5 rounded border border-dark/5 text-dark/60">Skill Injections</span>
                </div>
                <div className="absolute -right-3 -top-3 text-[#FF5F56] text-[24px] font-bold font-mono bg-[#FF5F56]/10 px-2 py-1 rounded-md border border-[#FF5F56]/20 shadow-sm flex items-center gap-1">
              ...
              <div className="flex ml-16 h-8 items-center relative">
                 ...
                 <div className="absolute left-0 -translate-x-[calc(50%-0.5px)] bg-white border border-prussian/20 text-prussian text-[24px] uppercase tracking-wider px-2 py-0.5 rounded-full font-mono flex items-center gap-1 shadow-sm">
              ...
              <div className="bg-prussian/5 p-4 rounded-xl flex items-center gap-4 border border-prussian/10 shadow-sm relative">
                ...
                <div className="flex gap-2 flex-wrap flex-1">
                   <span className="text-[24px] font-mono bg-white px-2 py-0.5 rounded border border-prussian/10 text-prussian/80">Zero History</span>
                   <span className="text-[24px] font-mono bg-white px-2 py-0.5 rounded border border-prussian/10 text-prussian/80">Pure Task Params</span>
                </div>
              </div>

            </div>

            <div className="bg-sand p-6 rounded-xl border border-dark/5 mt-4 text-dark/80 font-sans text-[24px] font-light shadow-sm">
