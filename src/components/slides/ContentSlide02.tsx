          ...
          <div className="flex-1 grid grid-cols-2 grid-rows-2 border-y border-prussian/20 relative">
            ...
            <div className="border-b border-prussian/20 p-8 flex flex-col justify-center">
              ...
              <p className="font-sans text-[24px] font-normal text-dark/70 leading-relaxed pr-8">
                ...
                <span className="text-dark/50 block mt-1">Allows trial & error, easy human intervention, clear SOP.</span>
              </p>
            </div>
            ...
            <div className="bg-gray-light/50 border-b border-prussian/20 p-8 flex flex-col justify-center relative">
              ...
              <p className="font-sans text-[24px] font-normal text-dark/80 leading-relaxed mb-6 pr-8">
                ...
                <span className="text-dark/50 block mt-1">High potential. Failures usually due to poor breakdown or missing context. Wiki/RAG helps here.</span>
              </p>
            </div>
            ...
            <div className="p-8 flex flex-col justify-center">
              ...
              <p className="font-sans text-[24px] font-normal text-dark/70 leading-relaxed pr-8">
                ...
                <span className="text-dark/50 block mt-1">Low tolerance, large blast radius. Human review is highly effective here.</span>
              </p>
            </div>
            ...
            <div className="bg-prussian text-white p-8 flex flex-col justify-center shadow-[inset_0_20px_40px_rgba(0,0,0,0.2)]">
              ...
              <h3 className="font-display text-4xl text-white mb-4"><b>投资与股市分析</b>、情绪干预、主观价值讨论<br/><span className="text-[28px] text-white/60 block mt-2 font-normal">Investment Analysis, Therapy, Subjective Debates</span></h3>
              <p className="font-sans text-[24px] font-light text-white/80 leading-relaxed pr-8 mb-6">
                难验证、易误判、代价高。涉及主观及高风险决策。<br/>
                <span className="text-white/50 block mt-1">Hard to verify, easy to misjudge, high cost. Involves subjective & risky decisions.</span>
              </p>
              <div className="mt-6 border-t border-white/20 pt-6">
                <p className="font-sans text-[24px] text-white/70 leading-relaxed font-light">
                  ...
                  <span className="text-[24px] text-white/50 block mt-1">Let's see how to make Claw's investment advice actually reliable.</span>
                </p>
              </div>
            </div>
