    ...
    <SlideWrapper>
      <div className="w-full h-full pt-16 px-24 pb-12 flex flex-col relative z-0">
        ...
        <div className="mb-8 w-full pl-4">
          <h1 className="font-display text-[4rem] leading-tight tracking-tighter text-dark mb-6">
            你司又做模型又做理财，怎么才能靠谱地让 Claw 给投资建议？
          </h1>
          <h2 className="font-display text-[28px] leading-tight text-dark/60 tracking-tight">
            Question first: how to safely get investment advice from Claw?
          </h2>
        </div>

        {/* Matrix Area */}
        <div className="flex-1 relative flex flex-col ml-12 mb-12 mt-4 justify-center">
          ...
          <div className="absolute top-1/2 left-0 -translate-x-1/2 -translate-y-1/2 -ml-12 -rotate-90 text-[24px] font-sans tracking-widest text-dark/80 whitespace-nowrap flex items-center gap-4 z-10 origin-center">
            ...
            <span className="font-bold text-prussian">容错率 / Error Tolerance</span>
            <div className="w-16 h-[1px] bg-prussian/40"></div>
            <span>高 / High</span>
          </div>

          {/* Grid setup */}
          <div className="h-[700px] grid grid-cols-2 grid-rows-2 border-y border-prussian/20 relative">
            ...
            <div className="bg-prussian text-white p-8 flex flex-col justify-center shadow-[inset_0_20px_40px_rgba(0,0,0,0.2)]">
              ...
              <h3 className="font-display text-4xl text-white mb-4"><b>投资与股市分析</b>、情绪干预、主观价值讨论<br/><span className="text-[28px] text-white/60 block mt-1 font-normal">Investment Analysis, Subjective Debates</span></h3>
              <p className="font-sans text-[24px] font-light text-white/80 leading-relaxed pr-8 mb-6">
                难验证、易误判、代价高。涉及主观及高风险决策。<br/>
                <span className="text-white/50 block">Hard to verify, high stakes. Subjective and risky.</span>
              </p>
              <div className="border-t border-white/20 pt-2">
                <p className="font-sans text-[24px] text-white/70 leading-relaxed font-light">
                  <span className="font-medium text-white/90">接下来看看，如果要让 Claw 推荐投资，怎么做更靠谱。<br/></span>
                  <span className="text-[24px] text-white/50 block">Let's see how to make Claw's investment advice reliable.</span>
                </p>
              </div>
            </div>
